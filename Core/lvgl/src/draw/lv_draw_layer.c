...
lv_draw_layer_ctx_t* lv_draw_layer_create(lv_draw_ctx_t *draw_ctx,
	...
	lv_draw_layer_ctx_t *layer_ctx = lv_mem_alloc(
			draw_ctx->layer_instance_size);
	...
	lv_draw_layer_ctx_t *init_layer_ctx = draw_ctx->layer_init(draw_ctx,
			layer_ctx, flags);
...
void lv_draw_layer_blend(struct _lv_draw_ctx_t *draw_ctx,
		struct _lv_draw_layer_ctx_t *layer_ctx, lv_draw_img_dsc_t *draw_dsc) {
