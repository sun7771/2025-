...
static void lv_style_set_prop_internal(lv_style_t *style,
		lv_style_prop_t prop_and_meta, lv_style_value_t value,
...
static void lv_style_set_prop_helper(lv_style_prop_t prop,
		lv_style_value_t value, uint16_t *prop_storage,
...
const uint8_t _lv_style_builtin_prop_flag_lookup_table[_LV_STYLE_NUM_BUILT_IN_PROPS] =
		{ [LV_STYLE_WIDTH] = LV_STYLE_PROP_LAYOUT_REFR, [LV_STYLE_MIN_WIDTH
				] = LV_STYLE_PROP_LAYOUT_REFR, [LV_STYLE_MAX_WIDTH
				] = LV_STYLE_PROP_LAYOUT_REFR, [LV_STYLE_HEIGHT
				] = LV_STYLE_PROP_LAYOUT_REFR, [LV_STYLE_MIN_HEIGHT
				] = LV_STYLE_PROP_LAYOUT_REFR, [LV_STYLE_MAX_HEIGHT
				] = LV_STYLE_PROP_LAYOUT_REFR, [LV_STYLE_X
				] = LV_STYLE_PROP_LAYOUT_REFR, [LV_STYLE_Y
				] = LV_STYLE_PROP_LAYOUT_REFR, [LV_STYLE_ALIGN
				] = LV_STYLE_PROP_LAYOUT_REFR, [LV_STYLE_TRANSFORM_WIDTH
				] = LV_STYLE_PROP_EXT_DRAW, [LV_STYLE_TRANSFORM_HEIGHT
				...
				[LV_STYLE_TRANSFORM_ZOOM] = LV_STYLE_PROP_EXT_DRAW
						| LV_STYLE_PROP_LAYER_REFR, [LV_STYLE_TRANSFORM_ANGLE
						] = LV_STYLE_PROP_EXT_DRAW | LV_STYLE_PROP_LAYER_REFR,

				[LV_STYLE_PAD_TOP] = LV_STYLE_PROP_EXT_DRAW
						| LV_STYLE_PROP_LAYOUT_REFR, [LV_STYLE_PAD_BOTTOM
						] = LV_STYLE_PROP_EXT_DRAW | LV_STYLE_PROP_LAYOUT_REFR,
				[LV_STYLE_PAD_LEFT] = LV_STYLE_PROP_EXT_DRAW
						| LV_STYLE_PROP_LAYOUT_REFR, [LV_STYLE_PAD_RIGHT
						] = LV_STYLE_PROP_EXT_DRAW | LV_STYLE_PROP_LAYOUT_REFR,
				[LV_STYLE_PAD_ROW] = LV_STYLE_PROP_EXT_DRAW
						| LV_STYLE_PROP_LAYOUT_REFR, [LV_STYLE_PAD_COLUMN
						] = LV_STYLE_PROP_EXT_DRAW | LV_STYLE_PROP_LAYOUT_REFR,

				[LV_STYLE_BG_COLOR] = 0, [LV_STYLE_BG_OPA] = 0,
				[LV_STYLE_BG_GRAD_COLOR] = 0, [LV_STYLE_BG_GRAD_DIR] = 0,
				[LV_STYLE_BG_MAIN_STOP] = 0, [LV_STYLE_BG_GRAD_STOP] = 0,
				[LV_STYLE_BG_GRAD] = 0, [LV_STYLE_BG_DITHER_MODE] = 0,

				[LV_STYLE_BG_IMG_SRC] = LV_STYLE_PROP_EXT_DRAW,
				[LV_STYLE_BG_IMG_OPA] = 0, [LV_STYLE_BG_IMG_RECOLOR] = 0,
				[LV_STYLE_BG_IMG_RECOLOR_OPA] = 0, [LV_STYLE_BG_IMG_TILED] = 0,

				[LV_STYLE_BORDER_COLOR] = 0, [LV_STYLE_BORDER_OPA] = 0,
				[LV_STYLE_BORDER_WIDTH] = LV_STYLE_PROP_LAYOUT_REFR,
				[LV_STYLE_BORDER_SIDE] = 0, [LV_STYLE_BORDER_POST] = 0,

				[LV_STYLE_OUTLINE_WIDTH] = LV_STYLE_PROP_EXT_DRAW,
				[LV_STYLE_OUTLINE_COLOR] = 0, [LV_STYLE_OUTLINE_OPA
						] = LV_STYLE_PROP_EXT_DRAW, [LV_STYLE_OUTLINE_PAD
						] = LV_STYLE_PROP_EXT_DRAW,
				...
				[LV_STYLE_SHADOW_COLOR] = 0, [LV_STYLE_SHADOW_OPA
						] = LV_STYLE_PROP_EXT_DRAW,

				[LV_STYLE_IMG_OPA] = 0, [LV_STYLE_IMG_RECOLOR] = 0,
				[LV_STYLE_IMG_RECOLOR_OPA] = 0,

				[LV_STYLE_LINE_WIDTH] = LV_STYLE_PROP_EXT_DRAW,
				[LV_STYLE_LINE_DASH_WIDTH] = 0, [LV_STYLE_LINE_DASH_GAP] = 0,
				[LV_STYLE_LINE_ROUNDED] = 0, [LV_STYLE_LINE_COLOR] = 0,
				[LV_STYLE_LINE_OPA] = 0,

				[LV_STYLE_ARC_WIDTH] = LV_STYLE_PROP_EXT_DRAW,
				[LV_STYLE_ARC_ROUNDED] = 0, [LV_STYLE_ARC_COLOR] = 0,
				[LV_STYLE_ARC_OPA] = 0, [LV_STYLE_ARC_IMG_SRC] = 0,

				[LV_STYLE_TEXT_COLOR] = LV_STYLE_PROP_INHERIT,
				[LV_STYLE_TEXT_OPA] = LV_STYLE_PROP_INHERIT, [LV_STYLE_TEXT_FONT
						] = LV_STYLE_PROP_INHERIT | LV_STYLE_PROP_LAYOUT_REFR,
				[LV_STYLE_TEXT_LETTER_SPACE] = LV_STYLE_PROP_INHERIT
						| LV_STYLE_PROP_LAYOUT_REFR, [LV_STYLE_TEXT_LINE_SPACE
						] = LV_STYLE_PROP_INHERIT | LV_STYLE_PROP_LAYOUT_REFR,
				[LV_STYLE_TEXT_DECOR] = LV_STYLE_PROP_INHERIT,
				[LV_STYLE_TEXT_ALIGN] = LV_STYLE_PROP_INHERIT
						| LV_STYLE_PROP_LAYOUT_REFR,

				[LV_STYLE_RADIUS] = 0, [LV_STYLE_CLIP_CORNER] = 0, [LV_STYLE_OPA
						] = LV_STYLE_PROP_LAYER_REFR, [LV_STYLE_COLOR_FILTER_DSC
						] = LV_STYLE_PROP_INHERIT, [LV_STYLE_COLOR_FILTER_OPA
						] = LV_STYLE_PROP_INHERIT, [LV_STYLE_ANIM_TIME] = 0,
				[LV_STYLE_ANIM_SPEED] = 0, [LV_STYLE_TRANSITION] = 0,
...
lv_style_prop_t lv_style_register_prop(uint8_t flag) {
	 ...
	 */
	size_t required_size = (last_custom_prop_id + 1
	...
	LV_GC_ROOT(_lv_style_custom_prop_flag_lookup_table)[last_custom_prop_id
			- _LV_STYLE_NUM_BUILT_IN_PROPS] = flag;
...
void lv_style_transition_dsc_init(lv_style_transition_dsc_t *tr,
		const lv_style_prop_t props[], lv_anim_path_cb_t path_cb, uint32_t time,
...
static void lv_style_set_prop_internal(lv_style_t *style,
	...
	if (style->prop_cnt > 1) {
		...
		for (i = style->prop_cnt - 1; i >= 0; i--) {
			if (LV_STYLE_PROP_ID_MASK(props[i]) == prop_id) {
				lv_style_value_t *values =
						(lv_style_value_t*) style->v_p.values_and_props;
				value_adjustment_helper(prop_and_meta, value, &props[i],
						&values[i]);
				return;
			}
		}
		...
		size_t size = (style->prop_cnt + 1)
				* (sizeof(lv_style_value_t) + sizeof(uint16_t));
		uint8_t *values_and_props = lv_mem_realloc(style->v_p.values_and_props,
				size);
