...
void setup_scr_screen_3(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_3_label_1, "异常！！！\n\n");
    lv_label_set_long_mode(ui->screen_3_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_3_label_1, -2, 87);
    lv_obj_set_size(ui->screen_3_label_1, 382, 94);
    ...
    lv_obj_set_style_text_font(ui->screen_3_label_1, &lv_font_SourceHanSansCN_Normal_41, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_3_btn_1, 107, 154);
    ...
    lv_obj_set_style_text_font(ui->screen_3_btn_1, &lv_font_SourceHanSansCN_Normal_16, LV_PART_MAIN|LV_STATE_DEFAULT);
